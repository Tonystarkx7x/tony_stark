...
from info import CHANNELS, ADMINS, AUTH_CHANNEL, LOG_CHANNEL, PICS, BATCH_FILE_CAPTION, CUSTOM_FILE_CAPTION, PROTECT_CONTENT, CHNL_LNK, GRP_LNK, REQST_CHANNEL, SUPPORT_CHAT_ID, TUTORIAL, IS_TUTORIAL, MAX_B_TN
from utils import get_settings, get_size, is_subscribed, save_group_settings, temp, get_tutorial
